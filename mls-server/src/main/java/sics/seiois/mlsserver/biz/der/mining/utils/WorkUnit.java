...
//    transient
    ...
    public WorkUnit(PredicateSet Xset, Predicate rhs, boolean compute_div_only) {
        this.currrent = Xset;
        this.rhss = new PredicateSet(rhs);
        this.currrentIndexs = new ArrayList<>();
        this.rhsIndexs = new ArrayList<>();
        this.columnsValueInt = new HashMap<>();
        this.columnsPLI = new HashMap<>();
        this.tidsIntervals = new HashMap<>();
        this.predicatesMLData = new HashMap<>();
        this.compute_div_only = compute_div_only;
        this.pids = null;
    }
...
//        }
        ...
        this.compute_div_only = task.isCompute_div_only();
    }

    public WorkUnit(WorkUnit task, ArrayList<Predicate> rhs_div_only, int[] pidCombination) {
...
//        log.info("### Work unit PLI : {}", this.columnsPLI);
    ...
    public void removeRHS(Predicate p) {
        this.rhss.remove(p);
    }
...
//    }
    ...
    public void write(Kryo kryo, Output output) {
        ...
        kryo.writeObject(output, compute_div_only);
    }
    ...
    public void read(Kryo kryo, Input input) {
        ...
        this.compute_div_only = kryo.readObject(input, Boolean.class);
    }
