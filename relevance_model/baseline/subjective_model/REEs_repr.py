...
class REEsRepr(object):
    def __init__(self,
        ...
        if vob_embeddings is None:
            ...
            self.tokensEmbedMatrix = tf.keras.layers.Embedding(self.vob_size, self.token_embedding_size, weights=[vob_embeddings], trainable=True)
