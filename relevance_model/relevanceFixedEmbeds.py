...
class RelevanceEmbeds(object):
    ...
    def construct(self):
        ...
        # self.subjective_left = tf.matmul(ree_embed_left, self.weight_relevance)
        # self.subjective_right = tf.matmul(ree_embed_right, self.weight_relevance)
        weight_ub = self.weight_ub_sub
        self.subjective_left = weight_ub - tf.nn.relu(tf.matmul(ree_embed_left, self.weight_relevance))
        self.subjective_right = weight_ub - tf.nn.relu(tf.matmul(ree_embed_right, self.weight_relevance))
